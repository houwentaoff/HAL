...
**
** \version     $Id: adi_ptz.h 1312 2014-09-04 10:07:16Z weiqiang $
**
...
typedef enum  {
    ADI_PTZ_PELCO_D,
    ADI_PTZ_PELCO_P,
    AID_PTZ_PROTOCOL_COUNT
}ADI_PTZ_ProtocolEnumT;
...
typedef struct
{
    const GADI_CHAR *name[AID_PTZ_PROTOCOL_COUNT];
    ADI_PTZ_ProtocolEnumT protocol;
    const GADI_PTZ_ProtocolCmdT *ptzProtocolCmd[AID_PTZ_PROTOCOL_COUNT];
    GADI_PTZ_ProtocolFunsT *ptzProtocolFuns[AID_PTZ_PROTOCOL_COUNT];
